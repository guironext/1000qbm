  ...
  if (!stage) {
    ...
    await prisma.stage.create({
      data: {
        ...
        langue: 'FR', // Enum value as string
        niveau: '1',
        numOrder: 1,
        image: 'https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=800&auto=format&fit=crop&q=60', // Generic Bible/book image
        statusStage: 'CURRENT', // Enum value as string
        descriptions: {
          create: [
            { texte: "Bienvenue dans cette première étape de votre voyage spirituel." },
