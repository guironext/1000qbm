        ...
        <section className="w-full lg:w-1/2 text-center lg:text-left space-y-6 lg:space-y-8">
          <div className="space-y-4">
            <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight">
              ...
              <div className="flex  gap-2 justify-center items-center w-full text-2xl md:text-4xl  font-light bg-blue-200 px-3 py-2 rounded-full my-2.5">
                <p>Jouer,</p>
                <p>Apprendre</p> et
                <p>Mémoriser</p>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
            <SignedIn>
              ...
              >
                ...
                {loading ? "Chargement..." : "Commencer à Jouer"}
              </Button>
            </SignedIn>
            <SignedOut>
              <Button
