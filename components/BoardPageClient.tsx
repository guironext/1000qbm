        ...
        <div className="block lg:hidden space-y-6">
          ...
          <div className=" rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div className="flex justify-center pt-4">
              <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg text-lg sm:text-xl transition-colors">
                Commençons
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 xl:space-y-8">
            ...
            <div className="space-y-4 xl:space-y-6">
              {stage.descriptions.map((d, index) => (
                <p
                  key={index}
                  className="text-lg xl:text-xl text-gray-700 leading-relaxed text-justify"
                >
                  {d.texte}
                </p>
              ))}
